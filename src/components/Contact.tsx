            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex flex-col space-y-6">
                <a href={`https://outlook.live.com/mail/0/deeplink/compose?to=${userInfo.contact.email}`} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4 text-gray-300 hover:text-white transition-colors">
                  ...
                  <span className="text-sm sm:text-base">{userInfo.contact.email}</span>
                </a>
                <a href="https://github.com/Khootz/" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4 text-gray-300 hover:text-white transition-colors">
                  <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center text-primary-foreground">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Right Column - LinkedIn and WhatsApp */}
              <div className="flex flex-col space-y-6">
